          ...
          <div className="grid gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
            <div>
              ...
              <ul className="mt-6 space-y-3 text-sm text-ink-900/70">
                {[
                  'Белый список маршрутов: наружу отдаётся ровно то, что нужно для бронирования, ничего лишнего',
                  'Сессия пассажира защищена отдельной cookie, не пересекается с админкой',
                  'Отдельная проверка источника для webhook-ов платёжной системы',
                  'Тот же движок мест и рейсов, что и в CRM — расхождений в остатках не бывает',
                ].map((item) => (
                  <li key={item} className="flex gap-3">
                    <span className="mt-1 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-sun-500" />
                    {item}
                  </li>
                ))}
              </ul>
            ...
            <BrowserMockup>
              ...
              <div className="mt-4 space-y-2 text-xs text-ink-900/50">
                <div className="flex items-center gap-2">
                  <CheckCircle2 size={13} className="text-green-500" /> /passenger/get-trips — разрешено
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle2 size={13} className="text-green-500" /> /passenger/book-seat — разрешено
                </div>
        ...
        <div className="container-page">
          ...
          <div className="mt-12 grid gap-5 sm:grid-cols-3">
            <FeatureCard icon={Bus} title="Рейсы по расписанию">
              ...
              рейса и посадочных мест на карте салона.
            </FeatureCard>
            <FeatureCard icon={Car} title="Трансферы" tone="sun">
              Отдельный сценарий бронирования индивидуального или группового
              трансфера — свои поля и своя логика цены.
            </FeatureCard>
            <FeatureCard icon={Users} title="Групповые туры">
              Бронирование мест для организованных групп — с той же
              инфраструктурой оплаты и билетов, что и для обычных рейсов.
            </FeatureCard>
          </div>
        </div>
      </section>
      ...
      <section className="bg-ink-50/40 py-20 sm:py-24">
        <div className="container-page">
          ...
          <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            <FeatureCard icon={CreditCard} title="Оплата онлайн">
              Приём платежей прямо на сайте — пассажир не идёт в кассу и не
              переводит деньги по номеру телефона.
            </FeatureCard>
            <FeatureCard icon={FileText} title="Электронный билет" tone="sun">
              PDF-билет с QR/номером генерируется сразу после оплаты и
