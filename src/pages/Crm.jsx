        ...
        <div className="container-page">
          ...
          <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <FeatureCard icon={ShieldCheck} title="Сессионная авторизация">
              Вход по телефону и коду подтверждения, привязанная сессия — без
              паролей, которые можно забыть или передать третьим лицам.
            </FeatureCard>
          </div>
        </div>
      </section>
        ...
        <div className="container-page">
          ...
          <div className="mx-auto mt-12 grid max-w-5xl gap-5 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <FeatureCard icon={ShieldCheck} title="Доступ только по VPN">
              Grafana открыта только из внутренней сети, Prometheus не
              выставлен наружу вовсе — метрики компании не утекут в интернет.
            </FeatureCard>
          </div>
        </div>
      </section>
