...
// источник данных: в проде это fetch на /kernel/get-passenger-info к реальной
// CRM, здесь — небольшой демонстрационный набор, т.к. у маркетингового сайта
// нет бэкенда. Стилизация — Tailwind вместо MUI/Bootstrap оригинала.
