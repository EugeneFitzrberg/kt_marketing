...
// Портировано из production-кода нашей CRM (Operators.js -> AccessRightsSection +
// OperatorCard.handleRightsChange). Реальные: список прав (те же ключи и подписи,
// что в CRM) и логика переключения
